...
<section <?php echo wp_kses_post( $content_block->get_block_id_attr() ); ?><?php echo wp_kses_post( $content_block->get_block_style_attr() ); ?>class="acf-block block-stat-strip<?php echo esc_attr( $content_block->get_block_classes() ); ?>">
