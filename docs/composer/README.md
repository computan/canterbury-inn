[⌂ Table of Contents](/docs/README.md) | [← Previous Article](/docs/gulp/lighthouse.md) | [Next Article →](/docs/composer/plugins.md)
...
Composer is used in the Catapult WordPress Framework to install:
